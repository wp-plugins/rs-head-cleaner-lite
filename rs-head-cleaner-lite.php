...
function rshcl_enqueue_styles() {
	global $rshcl_css_null; if ( !empty( $rshcl_css_null ) ) { return; }
	$slug			= rshcl_get_slug();
...
function rshcl_enqueue_scripts() {
	global $rshcl_js_null; if ( !empty( $rshcl_js_null ) ) { return; }
	$slug			= rshcl_get_slug();
